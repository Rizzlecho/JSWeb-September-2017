...
function viewAll(req, res) {
    ...
    if (path !== '/viewAllMemes') return true;

    else if (path === '/viewAllMemes') {
        ...
        for (let meme of memes) {
            memesHTML += `<div class="meme"><a href="/getDetails?id=${meme.id}"><img class="memePoster" src="${meme.memeSrc}"/></div>`;
        }
